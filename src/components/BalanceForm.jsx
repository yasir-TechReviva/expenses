...
function BalanceForm() {
  ...
  return (
    <div className="relative max-w-md mx-auto mt-10 p-6 bg-white rounded-xl shadow-lg ring-1 ring-gray-900/5 text-gray-700 transform hover:scale-105 transition-transform duration-300">
